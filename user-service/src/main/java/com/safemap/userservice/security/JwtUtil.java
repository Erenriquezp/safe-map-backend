package com.safemap.userservice.security;
...
public class JwtUtil {
    ...
    private final Key key = Keys.hmacShaKeyFor(Decoders.BASE64.decode(jwtSecret)); // Puedes usar un valor fijo en producción

    public String generateToken(User user) {
        // 1 día
        long jwtExpirationMs = 86400000;
        String jwtIssuer = "safemap-api";
        return Jwts.builder()
                .subject(user.getId())
